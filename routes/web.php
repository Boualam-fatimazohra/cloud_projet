...
Route::get('/categorie', function () {
    // Ici, vous pouvez renvoyer une vue, un composant Inertia, 
    // ou toute autre réponse que vous souhaitez.
    return Inertia::render('categori'); // Exemple avec Inertia
});

Route::get('/contact', function () {
    // Ici, vous pouvez renvoyer une vue, un composant Inertia, 
    // ou toute autre réponse que vous souhaitez.
    return Inertia::render('contact'); // Exemple avec Inertia
});
